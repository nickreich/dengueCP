...
## Nicholas Reich
library(ggplot2)
#HC library for reshape2 added as was needed for melt function below
library(reshape2)
...
## import births
births.raw <- read.csv("data/ThaiBirthData_1973_2010.csv",
...
# HC: rge changed from rrge as this was what was required by plot.den.ts (confirm if this is OK?)
rge <- range(d.tmp[,2:4])
